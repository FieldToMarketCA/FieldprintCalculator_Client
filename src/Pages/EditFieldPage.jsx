      ...
      axiosInstance
        .patch(
            ...
            `/farms/${farmContext.state._id.$oid}/fields/${fieldContext.state._id.$oid}`,
          {
            ...
            Ecodistrict: fieldContext.state.Ecodistrict.toString(),
            SLCpolygon: fieldContext.state.SLCpolygon.toString(),
          },
          {
            headers: {
        ...
        .then((response) => {
          navigate(
            `/farm/${fieldContext.state.farmId}/field/${fieldContext.state._id.$oid}`
          );
        });
    }
  }
