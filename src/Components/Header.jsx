  ...
  useEffect(() => {
    ...
    async function getUser() {
      ...
      try {
        ...
        if (query.get("token")){
          const response = await axios.get("http://127.0.0.1:8000/authenticate", {params: {token: query.get("token")}});
      ...
      <div className="my-auto flex items-center">
        ...
        <a href="http://127.0.0.1:8000/login/google">
          <IconButton aria-label="delete" size="large">
            {  user ? <Avatar alt="profile picture" src={user.picture}/> : <AccountCircleIcon className="text-white" fontSize="inherit" />}
          </IconButton>
        </a>
